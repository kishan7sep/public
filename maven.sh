...
wget https://dlcdn.apache.org/maven/maven-3/3.8.8/binaries/apache-maven-3.8.8-bin.zip -o $1/apache-maven-3.8.8-bin.zip
unzip $1/apache-maven-3.8.8-bin.zip -d $Agent.ToolsDirectory/
